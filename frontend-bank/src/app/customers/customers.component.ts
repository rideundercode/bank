...
@Component({
  ...
  styleUrls: ['./customers.component.css'] // Correction de styleUrl à styleUrls
})
export class CustomersComponent implements OnInit {
  public customers!: Customer[]; // Typage de customers
  public dataSource!: MatTableDataSource<Customer>; // Typage de dataSource
